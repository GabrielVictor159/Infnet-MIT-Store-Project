...
@Component
public class ConfirmUserEmailHandler implements CommandHandler<ConfirmUserEmailCommand, Boolean> {
   ...
   @Override
    public Boolean handle(ConfirmUserEmailCommand command) {
        ...
        try {
            ...
            bodyHtml = bodyHtml.replace("{{urlConfirmation}}", "http://localhost:8080/View/ConfirmUser/" + command.getConfirmId());
