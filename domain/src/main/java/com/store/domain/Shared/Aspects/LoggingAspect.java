package com.store.domain.Shared.Aspects;
...
import com.store.domain.Shared.Anotations.LogMask;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.store.domain.Application.Handlers..*.*(..))")
    public void applicationHandlersPointcut() {}
    @Pointcut("execution(* com.store.domain.Infraestructure.Repositories..*.*(..))")
